...
enyo.path.addPaths({layout: "/home/josh/Documents/Uni/Personal Project/cartographer-mockup/enyo/../lib/layout/", onyx: "/home/josh/Documents/Uni/Personal Project/cartographer-mockup/enyo/../lib/onyx/", onyx: "/home/josh/Documents/Uni/Personal Project/cartographer-mockup/enyo/../lib/onyx/source/"});
...
components: [ {
name: "ProgressTitle",
content: "Analysing Heightmap Data..."
}, {
name: "ProgressBar",
kind: "onyx.ProgressBar",
min: 0,
...
mousePress: function(e, t) {
this.$.SelectionOrb.applyStyle("left", t.screenX - 256 + "px"), this.$.SelectionOrb.applyStyle("top", t.screenY - 412 + "px"), this.$.SelectionOrb.addStyles("-webkit-transform: scale(0.0);");
},
mouseDragged: function(e, t) {
enyo.log(t), this.$.SelectionOrb.addStyles("-webkit-transform: scale(" + (Math.abs(t.dx) + Math.abs(t.dy)) * .003 + ");"), this.$.GenerateButton.getDisabled() && this.$.GenerateButton.setDisabled(!1);
},
generateTapped: function() {
this.$.ProgressPopup.show(), this.$.ProgressAnimator.play();
},
animatorStep: function(e) {
this.$.ProgressBar.setProgress(e.value), e.value >= 100 && this.$.ProgressTitle.setContent("Smoothing Terrain..."), e.value >= 200 && this.$.ProgressTitle.setContent("Processing Vector Data: Applying Landscape Colour"), e.value >= 220 && this.$.ProgressTitle.setContent("Processing Vector Data: Transport Nodes"), e.value >= 250 && this.$.ProgressTitle.setContent("Processing Vector Data: Water Volumes"), e.value >= 275 && this.$.ProgressTitle.setContent("Processing Vector Data: Structural Volumes"), e.value >= 300 && this.$.ProgressTitle.setContent("Processing Image Data: Landscape Detail"), e.value >= 350 && this.$.ProgressTitle.setContent("Processing Image Data: Structural Detail"), e.value >= 375 && this.$.ProgressTitle.setContent("Processing Image Data: Estimating Structure Heights"), e.value >= 430 && this.$.ProgressTitle.setContent("Processing Image Data: Tree Location"), e.value >= 460 && this.$.ProgressTitle.setContent("Processing Image Data: Identifying Walls"), e.value >= 500 && this.$.ProgressTitle.setContent("Processing Street View Images: Supplementing Structure Heights"), e.value >= 600 && this.$.ProgressTitle.setContent("Processing Street View Images: Supplementing Structure Surfaces"), e.value >= 700 && this.$.ProgressTitle.setContent("Processing Complete"), e.value >= 800 && this.$.ProgressPopup.hide();
}
});
